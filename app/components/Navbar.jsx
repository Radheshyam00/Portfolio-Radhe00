  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 
            ...
            <a href='#top'>
                <Image src={assets.logo} alt='' className='md:block hidden w-28 cursor-pointer mr-14'/>
            </a>
            ...
            <ul  ref={sideMenuRef}className='flex md:hidden flex-col gap-4 py-20 px-10 items-center 
            fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 text-black transition-duration-500 
            dark:bg-darkHover dark: text-white'>
                <div className='absolute right-6 top-6' onClick={closeManu}>
                    <Image src={isDarkMode ? assets.close_white : assets.close_black} alt='' className='w-5 cursor-pointer'/>
                </div>
                <li><a href='#top' className='font-Ovo' onClick={closeManu}>Home</a></li>
                <li><a href='#about' className='font-Ovo' onClick={closeManu}>About me</a></li>
